...
public class Levenshtein {
    ...
    public static void main(String[] args) {
        System.out.println(DamerauLevenshtein("turnover", "turnovre"));
        System.out.println(DamerauLevenshteinRecursion("abc", "cda"));
        System.out.println(LevenshteinRecursion("abb", "dbb"));
        System.out.println(Levenshtein("turnover", "turnovre"));
